...
В таблице размещена информация об образовательных партнёрах, номера договоров на организацию обучения, дата начала, дата окончания, квота по стоимости, квота по слушателям, текущий резерв квоты.
...
В таблице размещена информация о распределении квот между образовательными партнерами, можно узнать остаток квоты.&#x20;
...
В таблице размещена информация о расходовании квот на организацию обучения образовательными партнерами.&#x20;
