...
\- не ранее, чем через 7 рабочих дней от текущей даты (если включен автоматический выпуск приказов) и 9 рабочих дней если оспользуется ручной выпуск приказов (дата старта и текущая дая в 7 и 9 дней не входят).\
